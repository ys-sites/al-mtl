...
export function LanguageProvider({ children }: { children: React.ReactNode }) {
  ...
  const translations: Record<Language, Record<string, string>> = {
    en: {
      ...
      'step.02.title': 'Concept & 3D Presentation',
      'step.02.sub': 'See your ideas in high definition',
      'step.02.desc': 'We outline the project and guide you towards a functional and one-of-a-kind concept. Each project is accompanied by a high-end 3D presentation so you can see your colors and finishes before we begin.',
      ...
      'about.feat2': 'High-End 3D Presentation',
    ...
    fr: {
      ...
      'step.02.title': 'Concept et Présentation 3D',
      'step.02.sub': 'Voyez vos idées en haute définition',
      'step.02.desc': 'Nous esquissons le projet et vous guidons vers un concept fonctionnel et unique. Chaque projet est accompagné d\'une présentation 3D haut de gamme afin que vous puissiez voir vos couleurs et finitions avant que nous commencions.',
      ...
      'about.feat2': 'Présentation 3D Haut de Gamme',
